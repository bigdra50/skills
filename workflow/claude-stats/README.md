...
```bash
apm install bigdra50/skills/workflow/claude-stats
```
...
dependencies:
  apm:
    - bigdra50/skills/workflow/claude-stats
```
...
```bash
npx degit bigdra50/skills/workflow/claude-stats ~/.claude/skills/claude-stats
```
