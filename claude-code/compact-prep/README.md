...
```bash
apm install bigdra50/skills/claude-code/compact-prep
```
...
```bash
npx degit bigdra50/skills/claude-code/compact-prep ~/.claude/skills/compact-prep
```
