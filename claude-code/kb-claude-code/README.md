...
```bash
apm install bigdra50/skills/claude-code/kb-claude-code
```
...
dependencies:
  apm:
    - bigdra50/skills/claude-code/kb-claude-code
```
...
```bash
npx degit bigdra50/skills/claude-code/kb-claude-code ~/.claude/skills/kb-claude-code
```
